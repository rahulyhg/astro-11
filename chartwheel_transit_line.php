...
// put planets in chartwheel - person 1
  ...
  for ($i = $num_planets - 1; $i >= 0; $i--)
  {
    ...
    if ($flag == False)
    {
      imagettftext($im, 16, 0, $x1 + $x_offset, $y_line_dist1 - 20, $planet_color, HAMBURG_TTF, chr($pl_glyph[$sort_pos1[$i]]));
    }
    else
    {
      imagettftext($im, 16, 0, $x1 + $x_offset, $y_line_dist1 - 38, $planet_color, HAMBURG_TTF, chr($pl_glyph[$sort_pos1[$i]]));
    }
...
// put planets in chartwheel - person 2
  ...
  for ($i = $num_planets - 1; $i >= 0; $i--)
  {
    ...
    if ($flag == False)
    {
      imagettftext($im, 16, 0, $x1 + $x_offset, $y_line_dist2 + 37, $planet_color, HAMBURG_TTF, chr($pl_glyph[$sort_pos2[$i]]));
    }
    else
    {
      imagettftext($im, 16, 0, $x1 + $x_offset, $y_line_dist2 + 55, $planet_color, HAMBURG_TTF, chr($pl_glyph[$sort_pos2[$i]]));
    }
